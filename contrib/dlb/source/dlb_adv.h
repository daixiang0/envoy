 ...
 */
int dlb_adv_send(dlb_port_hdl_t hdl, uint32_t num, dlb_event_t* events);
 ...
 */
int dlb_adv_create_sched_domain(dlb_hdl_t hdl, struct dlb_create_sched_domain* args,
                                dlb_adv_create_sched_domain_t* adv_args);
 ...
 */
int64_t dlb_adv_read_queue_depth_counter(dlb_domain_hdl_t hdl, int queue_id, bool is_dir,
                                         dlb_queue_depth_levels_t level);
 ...
 * @exception EINVAL Invalid queue ID or level
 */
int dlb_adv_reset_queue_depth_counter(dlb_domain_hdl_t hdl, int queue_id, bool is_dir,
                                      dlb_queue_depth_levels_t level);
