 ...
 *                   DLB driver
 */
int dlb_open(int device_id, dlb_hdl_t* hdl);
 ...
 */
int dlb_get_dev_capabilities(dlb_hdl_t hdl, dlb_dev_cap_t* cap);
 ...
 */
int dlb_get_num_resources(dlb_hdl_t hdl, dlb_resources_t* rsrcs);
 ...
 *                   changed
 */
int dlb_set_ldb_sequence_number_allocation(dlb_hdl_t hdl, unsigned int group, unsigned int num);
 ...
 */
int dlb_get_ldb_sequence_number_allocation(dlb_hdl_t hdl, unsigned int group, unsigned int* num);
 ...
 * @exception EINVAL Invalid group ID or num is NULL
 */
int dlb_get_ldb_sequence_number_occupancy(dlb_hdl_t hdl, unsigned int group, unsigned int* num);
 ...
 * @exception EINVAL Invalid DLB handle
 */
int dlb_get_num_ldb_sequence_number_groups(dlb_hdl_t hdl);
 ...
 * @exception EINVAL Invalid DLB handle
 */
int dlb_get_min_ldb_sequence_number_allocation(dlb_hdl_t hdl);
 ...
 */
int dlb_create_sched_domain(dlb_hdl_t hdl, dlb_create_sched_domain_t* args);
 ...
 */
dlb_domain_hdl_t dlb_attach_sched_domain(dlb_hdl_t hdl, int domain_id);
 ...
 */
int dlb_detach_sched_domain(dlb_domain_hdl_t hdl);
 ...
 *                   combined_credits capability
 */
int dlb_create_ldb_credit_pool(dlb_domain_hdl_t hdl, int num_credits);
 ...
 *                   combined_credits capability
 */
int dlb_create_dir_credit_pool(dlb_domain_hdl_t hdl, int num_credits);
 ...
 *                   combined_credits capability
 */
int dlb_create_credit_pool(dlb_domain_hdl_t hdl, int num_credits);
 ...
 */
int dlb_create_ldb_queue(dlb_domain_hdl_t hdl, dlb_create_ldb_queue_t* args);
 ...
 */
int dlb_create_dir_queue(dlb_domain_hdl_t hdl, int port_id);
...
typedef struct {
  union {
    ...
    struct {
      ...
      /** Number of directed credits. If 0, the port cannot send directed
       * events.
       */
    ...
    struct {
      ...
      /** Number of credits. If 0, the port cannot send events. */
 ...
 * @exception EINVAL Invalid credit pool ID, insufficient available credits, or
 *                   invalid CQ depth
 */
int dlb_create_ldb_port(dlb_domain_hdl_t hdl, dlb_create_port_t* args);
 ...
 *                   invalid CQ depth
 */
int dlb_create_dir_port(dlb_domain_hdl_t hdl, dlb_create_port_t* args, int queue_id);
 ...
 */
dlb_port_hdl_t dlb_attach_ldb_port(dlb_domain_hdl_t hdl, int port_id);
 ...
 * @exception EINVAL Invalid port ID
 */
dlb_port_hdl_t dlb_attach_dir_port(dlb_domain_hdl_t hdl, int port_id);
 ...
 */
int dlb_detach_port(dlb_port_hdl_t hdl);
 ...
 */
int dlb_set_wait_profile(dlb_port_hdl_t hdl, dlb_api_class_t api_class, dlb_wait_profile_t profile);
 ...
 */
int dlb_get_wait_profile(dlb_port_hdl_t hdl, dlb_api_class_t api_class,
                         dlb_wait_profile_t* profile);
 ...
 */
int dlb_enable_cq_weight(dlb_port_hdl_t hdl);
 ...
 */
int dlb_link_queue(dlb_port_hdl_t hdl, int queue_id, int priority);
 ...
 */
int dlb_unlink_queue(dlb_port_hdl_t hdl, int queue_id);
 ...
 * @exception EINVAL Invalid port handle
 */
int dlb_enable_port_sched(dlb_port_hdl_t hdl);
 ...
 * @exception EINVAL Invalid port handle
 */
int dlb_disable_port_sched(dlb_port_hdl_t hdl);
 ...
 * @exception EINVAL Invalid port handle
 */
int dlb_enable_port(dlb_port_hdl_t hdl);
 ...
 * @exception EINVAL Invalid port handle
 */
int dlb_disable_port(dlb_port_hdl_t hdl);
 ...
 */
int dlb_start_sched_domain(dlb_domain_hdl_t hdl);
 ...
 *                   handle
 */
int dlb_reset_sched_domain(dlb_hdl_t hdl, int domain_id);
 ...
 */
typedef void (*domain_alert_callback_t)(dlb_alert_t* alert, int domain_id, void* arg);
 ...
 * @see dlb_alert_id_t
 */
int dlb_launch_domain_alert_thread(dlb_domain_hdl_t hdl, domain_alert_callback_t callback,
                                   void* callback_arg);
 ...
 */
int dlb_send(dlb_port_hdl_t hdl, uint32_t num, dlb_event_t* events);
 ...
 * @exception EACCES The port is disabled
 */
int dlb_release(dlb_port_hdl_t hdl, uint32_t num);
 ...
 * @exception EACCES The port is disabled
 */
int dlb_forward(dlb_port_hdl_t hdl, uint32_t num, dlb_event_t* events);
 ...
 * @exception EACCES The port is disabled
 */
int dlb_pop_cq(dlb_port_hdl_t hdl, uint32_t num);
 ...
 */
int dlb_recv(dlb_port_hdl_t hdl, uint32_t max, bool wait, dlb_event_t* events);
 ...
 * @exception EACCES The port is disabled and there are no events in its CQ
 */
int dlb_recv_no_pop(dlb_port_hdl_t hdl, uint32_t max, bool wait, dlb_event_t* events);
 ...
 * @exception EINVAL Invalid port handle
 */
int dlb_enable_cq_epoll(dlb_port_hdl_t hdl, bool is_ldb, int efd);
