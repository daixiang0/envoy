...
static const char dlb2_domain_alert_strings[][128] = {
    "DLB2_DOMAIN_ALERT_PP_ILLEGAL_ENQ", "DLB2_DOMAIN_ALERT_PP_EXCESS_TOKEN_POPS",
    "DLB2_DOMAIN_ALERT_ILLEGAL_HCW",    "DLB2_DOMAIN_ALERT_ILLEGAL_QID",
    "DLB2_DOMAIN_ALERT_DISABLED_QID",   "DLB2_DOMAIN_ALERT_DEVICE_RESET",
    "DLB2_DOMAIN_ALERT_USER",           "DLB2_DOMAIN_ALERT_CQ_WATCHDOG_TIMEOUT",
};
...
#define DLB2_IOC_GET_DEVICE_VERSION                                                                \
  _IOR(DLB2_IOC_MAGIC, DLB2_CMD_GET_DEVICE_VERSION, struct dlb2_get_device_version_args)
#define DLB2_IOC_CREATE_SCHED_DOMAIN                                                               \
  _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_CREATE_SCHED_DOMAIN, struct dlb2_create_sched_domain_args)
#define DLB2_IOC_GET_NUM_RESOURCES                                                                 \
  _IOR(DLB2_IOC_MAGIC, DLB2_CMD_GET_NUM_RESOURCES, struct dlb2_get_num_resources_args)
#define DLB2_IOC_SET_SN_ALLOCATION                                                                 \
  _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_SET_SN_ALLOCATION, struct dlb2_set_sn_allocation_args)
#define DLB2_IOC_GET_SN_ALLOCATION                                                                 \
  _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_GET_SN_ALLOCATION, struct dlb2_get_sn_allocation_args)
#define DLB2_IOC_SET_COS_BW _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_SET_COS_BW, struct dlb2_set_cos_bw_args)
#define DLB2_IOC_GET_COS_BW _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_GET_COS_BW, struct dlb2_get_cos_bw_args)
#define DLB2_IOC_GET_SN_OCCUPANCY                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_CMD_GET_SN_OCCUPANCY, struct dlb2_get_sn_occupancy_args)
#define DLB2_IOC_QUERY_CQ_POLL_MODE                                                                \
  _IOR(DLB2_IOC_MAGIC, DLB2_CMD_QUERY_CQ_POLL_MODE, struct dlb2_query_cq_poll_mode_args)
#define DLB2_IOC_CREATE_LDB_QUEUE                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_CREATE_LDB_QUEUE, struct dlb2_create_ldb_queue_args)
#define DLB2_IOC_CREATE_DIR_QUEUE                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_CREATE_DIR_QUEUE, struct dlb2_create_dir_queue_args)
#define DLB2_IOC_CREATE_LDB_PORT                                                                   \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_CREATE_LDB_PORT, struct dlb2_create_ldb_port_args)
#define DLB2_IOC_CREATE_DIR_PORT                                                                   \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_CREATE_DIR_PORT, struct dlb2_create_dir_port_args)
#define DLB2_IOC_START_DOMAIN                                                                      \
  _IOR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_START_DOMAIN, struct dlb2_start_domain_args)
#define DLB2_IOC_MAP_QID _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_MAP_QID, struct dlb2_map_qid_args)
#define DLB2_IOC_UNMAP_QID                                                                         \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_UNMAP_QID, struct dlb2_unmap_qid_args)
#define DLB2_IOC_ENABLE_LDB_PORT                                                                   \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_ENABLE_LDB_PORT, struct dlb2_enable_ldb_port_args)
#define DLB2_IOC_ENABLE_DIR_PORT                                                                   \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_ENABLE_DIR_PORT, struct dlb2_enable_dir_port_args)
#define DLB2_IOC_DISABLE_LDB_PORT                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_DISABLE_LDB_PORT, struct dlb2_disable_ldb_port_args)
#define DLB2_IOC_DISABLE_DIR_PORT                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_DISABLE_DIR_PORT, struct dlb2_disable_dir_port_args)
#define DLB2_IOC_BLOCK_ON_CQ_INTERRUPT                                                             \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_BLOCK_ON_CQ_INTERRUPT,                                     \
        struct dlb2_block_on_cq_interrupt_args)
#define DLB2_IOC_ENQUEUE_DOMAIN_ALERT                                                              \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_ENQUEUE_DOMAIN_ALERT, struct dlb2_enqueue_domain_alert_args)
#define DLB2_IOC_GET_LDB_QUEUE_DEPTH                                                               \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_LDB_QUEUE_DEPTH, struct dlb2_get_ldb_queue_depth_args)
#define DLB2_IOC_GET_DIR_QUEUE_DEPTH                                                               \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_DIR_QUEUE_DEPTH, struct dlb2_get_dir_queue_depth_args)
#define DLB2_IOC_PENDING_PORT_UNMAPS                                                               \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_PENDING_PORT_UNMAPS, struct dlb2_pending_port_unmaps_args)
#define DLB2_IOC_GET_LDB_PORT_PP_FD                                                                \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_LDB_PORT_PP_FD, struct dlb2_get_port_fd_args)
#define DLB2_IOC_GET_LDB_PORT_CQ_FD                                                                \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_LDB_PORT_CQ_FD, struct dlb2_get_port_fd_args)
#define DLB2_IOC_GET_DIR_PORT_PP_FD                                                                \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_DIR_PORT_PP_FD, struct dlb2_get_port_fd_args)
#define DLB2_IOC_GET_DIR_PORT_CQ_FD                                                                \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_GET_DIR_PORT_CQ_FD, struct dlb2_get_port_fd_args)
#define DLB2_IOC_ENABLE_CQ_WEIGHT                                                                  \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_ENABLE_CQ_WEIGHT, struct dlb2_enable_cq_weight_args)
#define DLB2_IOC_ENABLE_CQ_EPOLL                                                                   \
  _IOWR(DLB2_IOC_MAGIC, DLB2_DOMAIN_CMD_ENABLE_CQ_EPOLL, struct dlb2_enable_cq_epoll_args)
#endif /* __DLB2_USER_H */
